...
int main()
{
    ...
    for(int alg = 0; alg < 15; alg++)
    {
        ...
        switch(alg)
        {
            ...
            case 7: run_rr(proc, n, DEFAULT_TQ); break;
            case 8: run_mlq(proc, n, DEFAULT_TQ); break;
            case 9: run_mlfq(proc, n); break;
            case 10: run_priority_rr(proc, n, DEFAULT_TQ); break;
            case 11: run_priority_update(proc, n, DEFAULT_ALPHA, DEFAULT_BETA); break;
